...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source =.; Initial Catalog = BikeStore; TrustServerCertificate=True;Integrated Security = SSPI");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Brand>(entity =>
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E278BF07FC7");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B44F2A914B");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB85DC9542D8");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__4659622951B16626");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D48918078D");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF5E32CA6DD");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9C0F6BEE84");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E6164D0DF7A94").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D36CC3982D");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C0206CBC3");
